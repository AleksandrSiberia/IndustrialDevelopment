...
final class CustomButton: UIButton {
    ...
    init(title: String, titleColor: UIColor = .white, bgColor: UIColor = UIColor.createColorForTheme(lightTheme: UIColor(named: "MyColorSet") ?? .blue, darkTheme: .systemGray4), targetAction: @escaping Action) {
